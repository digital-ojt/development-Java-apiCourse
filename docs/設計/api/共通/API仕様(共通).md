...
- [業務要件書](../../../要件定義/business-requirements.md)
...
- [部品在庫照会 API](./部品在庫管理/部品在庫照会API.yaml)
- [部品入荷 API](./部品在庫管理/部品入荷API.yaml)
- [部品入荷取消 API](./部品在庫管理/部品入荷取消API.yaml)
- [部品出庫 API](./部品在庫管理/部品出庫API.yaml)
- [部品出庫取消 API](./部品在庫管理/部品出庫取消API.yaml)

#### 製品在庫管理

- [製品在庫照会 API](./製品在庫管理/製品在庫照会API.yaml)
- [製品入荷 API](./製品在庫管理/製品入荷API.yaml)
- [製品出荷 API](./製品在庫管理/製品出荷API.yaml)
- [製品出荷取消 API](./製品在庫管理/製品出荷取消API.yaml)
